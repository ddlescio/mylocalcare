...
TRANSLATIONS = {
    ...
    "availability.absences_title": {
        "it": "Periodi di assenza", "en": "Periods away", "fr": "Périodes d’absence",
        "es": "Períodos de ausencia", "de": "Abwesenheitszeiträume",
        "ro": "Perioade de absență", "uk": "Періоди відсутності", "fil": "Mga panahon ng pagliban",
    },
    "availability.absences_help": {
        "it": "Indica i periodi in cui non potrai svolgere servizi.",
        "en": "Add periods when you will not be able to provide services.",
        "fr": "Indiquez les périodes où vous ne pourrez pas assurer de services.",
        "es": "Indica los períodos en los que no podrás prestar servicios.",
        "de": "Gib Zeiträume an, in denen du keine Dienstleistungen erbringen kannst.",
        "ro": "Indică perioadele în care nu vei putea presta servicii.",
        "uk": "Зазначте періоди, коли ви не зможете надавати послуги.",
        "fil": "Ilagay ang mga panahong hindi ka makakapagbigay ng serbisyo.",
    },
    "availability.add_absence": {
        "it": "Aggiungi assenza", "en": "Add period away", "fr": "Ajouter une absence",
        "es": "Añadir ausencia", "de": "Abwesenheit hinzufügen", "ro": "Adaugă o absență",
        "uk": "Додати відсутність", "fil": "Magdagdag ng pagliban",
    },
    "availability.start": {
    ...
    "availability.empty_absences": {
        "it": "Nessun periodo di assenza aggiunto.",
        "en": "No periods away added.",
        "fr": "Aucune période d’absence ajoutée.",
        "es": "No se ha añadido ningún período de ausencia.",
        "de": "Keine Abwesenheit hinzugefügt.",
        "ro": "Nu a fost adăugată nicio perioadă de absență.",
        "uk": "Періоди відсутності не додано.",
        "fil": "Wala pang idinagdag na panahon ng pagliban.",
    },
