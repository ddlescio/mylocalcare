...
TRANSLATIONS = {
    ...
    "search.available_only": {
        "it": "Disponibilità confermata", "en": "Confirmed availability",
        "fr": "Disponibilité confirmée", "es": "Disponibilidad confirmada",
        "de": "Bestätigte Verfügbarkeit", "ro": "Disponibilitate confirmată",
        "uk": "Підтверджена доступність", "fil": "Kumpirmadong availability",
    },
    "search.available_only_hint": {
        "it": "Mostra solo chi ha confermato di essere disponibile negli ultimi 44 giorni.",
        "en": "Show only people who confirmed their availability in the last 44 days.",
        "fr": "Afficher uniquement les personnes ayant confirmé leur disponibilité au cours des 44 derniers jours.",
        "es": "Muestra solo a quienes confirmaron su disponibilidad en los últimos 44 días.",
        "de": "Nur Personen anzeigen, die ihre Verfügbarkeit in den letzten 44 Tagen bestätigt haben.",
        "ro": "Arată doar persoanele care și-au confirmat disponibilitatea în ultimele 44 de zile.",
        "uk": "Показувати лише тих, хто підтвердив доступність протягом останніх 44 днів.",
        "fil": "Ipakita lamang ang mga nagkumpirma ng availability sa nakalipas na 44 araw.",
    },
    "search.no_available_results": {
        "it": "Nessun annuncio con disponibilità aggiornata",
        "en": "No listings with up-to-date availability",
        "fr": "Aucune annonce avec une disponibilité à jour",
        "es": "No hay anuncios con disponibilidad actualizada",
        "de": "Keine Anzeigen mit aktueller Verfügbarkeit",
        "ro": "Niciun anunț cu disponibilitate actualizată",
        "uk": "Немає оголошень з актуальною доступністю",
        "fil": "Walang listing na may updated na availability",
    },
    "search.no_available_results_hint": {
        "it": "Con questi filtri non risultano persone con disponibilità confermata e ancora valida.",
        "en": "No people with confirmed, still-valid availability match these filters.",
        "fr": "Aucune personne avec une disponibilité confirmée et encore valable ne correspond à ces filtres.",
        "es": "Ninguna persona con disponibilidad confirmada y aún válida coincide con estos filtros.",
        "de": "Für diese Filter gibt es keine Personen mit bestätigter, noch gültiger Verfügbarkeit.",
        "ro": "Nicio persoană cu disponibilitate confirmată și încă valabilă nu corespunde acestor filtre.",
        "uk": "За цими фільтрами немає людей із підтвердженою та чинною доступністю.",
        "fil": "Walang tumutugma sa mga filter na ito na may kumpirmado at balidong availability.",
    },
    "search.show_all_listings": {
        "it": "Mostra tutti gli annunci", "en": "Show all listings",
        "fr": "Afficher toutes les annonces", "es": "Mostrar todos los anuncios",
        "de": "Alle Anzeigen anzeigen", "ro": "Arată toate anunțurile",
        "uk": "Показати всі оголошення", "fil": "Ipakita ang lahat ng listing",
    },
    ...
    "availability.on_call_title": {
        "it": "Disponibilità a chiamata", "en": "On-call availability",
        "fr": "Disponibilité sur appel", "es": "Disponibilidad bajo demanda",
        "de": "Verfügbarkeit auf Abruf", "ro": "Disponibilitate la cerere",
        "uk": "Доступність за викликом", "fil": "On-call availability",
    },
    "availability.on_call_label": {
        "it": "A chiamata", "en": "On call", "fr": "Sur appel",
        "es": "Bajo demanda", "de": "Auf Abruf", "ro": "La cerere",
        "uk": "За викликом", "fil": "On call",
    },
    "availability.on_call_help": {
        "it": "Puoi accettare richieste occasionali o con orari da concordare. Puoi selezionarla da sola o insieme alle fasce.",
        "en": "You can accept occasional requests or agree the time directly. Select this alone or alongside scheduled times.",
        "fr": "Vous pouvez accepter des demandes ponctuelles ou convenir directement des horaires. Sélectionnez cette option seule ou avec des créneaux.",
        "es": "Puedes aceptar solicitudes puntuales o acordar directamente el horario. Selecciona esta opción sola o junto con franjas horarias.",
        "de": "Du kannst gelegentliche Anfragen annehmen oder die Zeit direkt vereinbaren. Wähle diese Option allein oder zusätzlich zu Zeitfenstern.",
        "ro": "Poți accepta solicitări ocazionale sau poți stabili direct programul. Selectează opțiunea singură sau împreună cu intervalele.",
        "uk": "Ви можете приймати разові запити або домовлятися про час напряму. Оберіть цей варіант окремо або разом із часовими проміжками.",
        "fil": "Maaari kang tumanggap ng paminsan-minsang request o direktang magkasundo sa oras. Piliin ito nang mag-isa o kasama ng mga iskedyul na oras.",
    },
    ...
    "availability.from": {
        "it": "Dalle", "en": "From", "fr": "Du", "es": "Desde",
    ...
    "availability_request.open": {
        "it": "Invia la tua richiesta", "en": "Send your request",
        "fr": "Envoyer votre demande", "es": "Envía tu solicitud",
        "de": "Deine Anfrage senden", "ro": "Trimite solicitarea ta",
        "uk": "Надіслати свій запит", "fil": "Ipadala ang iyong request",
    },
    "availability_request.eyebrow": {
        "it": "RICHIESTA DISPONIBILITÀ", "en": "AVAILABILITY REQUEST",
        "fr": "DEMANDE DE DISPONIBILITÉ", "es": "SOLICITUD DE DISPONIBILIDAD",
        "de": "VERFÜGBARKEITSANFRAGE", "ro": "SOLICITARE DE DISPONIBILITATE",
        "uk": "ЗАПИТ ДОСТУПНОСТІ", "fil": "AVAILABILITY REQUEST",
    },
    "availability_request.title": {
        "it": "Quando ti serve il servizio?", "en": "When do you need the service?",
        "fr": "Quand avez-vous besoin du service ?", "es": "¿Cuándo necesitas el servicio?",
        "de": "Wann benötigst du die Dienstleistung?", "ro": "Când ai nevoie de serviciu?",
        "uk": "Коли вам потрібна послуга?", "fil": "Kailan mo kailangan ang serbisyo?",
    },
    "availability_request.subtitle": {
        "it": "Indica i giorni e gli orari che ti interessano. Puoi scegliere fasce ampie, intervalli precisi o entrambi.",
        "en": "Choose the days and times you need. You can select broad time slots, exact intervals or both.",
        "fr": "Indiquez les jours et horaires souhaités. Vous pouvez choisir des créneaux larges, des horaires précis ou les deux.",
        "es": "Indica los días y horarios que te interesan. Puedes elegir franjas amplias, intervalos exactos o ambos.",
        "de": "Wähle die gewünschten Tage und Zeiten. Du kannst grobe Zeitfenster, genaue Zeiträume oder beides angeben.",
        "ro": "Indică zilele și orele care te interesează. Poți alege intervale generale, ore exacte sau ambele.",
        "uk": "Вкажіть потрібні дні й час. Можна вибрати широкі часові проміжки, точні інтервали або обидва варіанти.",
        "fil": "Piliin ang mga araw at oras na kailangan mo. Maaari kang pumili ng malawak na time slot, eksaktong interval, o pareho.",
    },
    "availability_request.selection_title": {
        "it": "Scegli giorni e orari", "en": "Choose days and times",
        "fr": "Choisissez les jours et horaires", "es": "Elige días y horarios",
        "de": "Tage und Zeiten auswählen", "ro": "Alege zilele și orele",
        "uk": "Виберіть дні й час", "fil": "Pumili ng mga araw at oras",
    },
    "availability_request.selection_help": {
        "it": "Scegli A chiamata, uno o più giorni con orari, oppure entrambe le soluzioni.",
        "en": "Choose On call, one or more days with times, or both options.",
        "fr": "Choisissez Sur appel, un ou plusieurs jours avec horaires, ou les deux options.",
        "es": "Elige Bajo demanda, uno o varios días con horarios, o ambas opciones.",
        "de": "Wähle Auf Abruf, einen oder mehrere Tage mit Zeiten oder beides.",
        "ro": "Alege La cerere, una sau mai multe zile cu ore, sau ambele opțiuni.",
        "uk": "Оберіть За викликом, один чи кілька днів із часом або обидва варіанти.",
        "fil": "Piliin ang On call, isa o higit pang araw na may oras, o pareho.",
    },
    "availability_request.on_call_help": {
        "it": "Per richieste occasionali o quando giorno e orario sono da concordare.",
        "en": "For occasional requests or when the day and time will be agreed later.",
        "fr": "Pour les demandes ponctuelles ou lorsque le jour et l’heure seront convenus plus tard.",
        "es": "Para solicitudes puntuales o cuando el día y la hora se acordarán después.",
        "de": "Für gelegentliche Anfragen oder wenn Tag und Uhrzeit später vereinbart werden.",
        "ro": "Pentru solicitări ocazionale sau când ziua și ora vor fi stabilite ulterior.",
        "uk": "Для разових запитів або коли день і час буде узгоджено пізніше.",
        "fil": "Para sa paminsan-minsang request o kung pag-uusapan pa ang araw at oras.",
    },
    "availability_request.chat_preview": {
        "it": "Richiesta di disponibilità",
        "en": "Availability request",
        "fr": "Demande de disponibilité",
        "es": "Solicitud de disponibilidad",
        "de": "Verfügbarkeitsanfrage",
        "ro": "Solicitare de disponibilitate",
        "uk": "Запит доступності",
        "fil": "Availability request",
    },
    "availability_request.chat_preview_available": {
        "it": "Disponibilità confermata",
        "en": "Availability confirmed",
        "fr": "Disponibilité confirmée",
        "es": "Disponibilidad confirmada",
        "de": "Verfügbarkeit bestätigt",
        "ro": "Disponibilitate confirmată",
        "uk": "Доступність підтверджено",
        "fil": "Nakumpirma ang availability",
    },
    "availability_request.chat_preview_unavailable": {
        "it": "Non disponibile per la richiesta",
        "en": "Unavailable for the request",
        "fr": "Indisponible pour la demande",
        "es": "No disponible para la solicitud",
        "de": "Für die Anfrage nicht verfügbar",
        "ro": "Indisponibil pentru solicitare",
        "uk": "Недоступно для цього запиту",
        "fil": "Hindi available para sa request",
    },
    "availability_request.chat_preview_information": {
        "it": "Richiesta di maggiori informazioni",
        "en": "More information requested",
        "fr": "Demande d’informations supplémentaires",
        "es": "Solicitud de más información",
        "de": "Weitere Informationen angefordert",
        "ro": "Solicitare de informații suplimentare",
        "uk": "Запит додаткової інформації",
        "fil": "Humiling ng karagdagang impormasyon",
    },
    "availability_request.exact_intervals": {
        "it": "Intervalli precisi", "en": "Exact intervals",
        "fr": "Horaires précis", "es": "Intervalos exactos",
        "de": "Genaue Zeiträume", "ro": "Intervale exacte",
        "uk": "Точні інтервали", "fil": "Eksaktong mga interval",
    },
    "availability_request.add_interval": {
        "it": "Aggiungi intervallo", "en": "Add interval",
        "fr": "Ajouter un horaire", "es": "Añadir intervalo",
        "de": "Zeitraum hinzufügen", "ro": "Adaugă un interval",
        "uk": "Додати інтервал", "fil": "Magdagdag ng interval",
    },
    "availability_request.interval_label": {
        "it": "Intervallo preciso", "en": "Exact interval",
        "fr": "Horaire précis", "es": "Intervalo exacto",
        "de": "Genauer Zeitraum", "ro": "Interval exact",
        "uk": "Точний інтервал", "fil": "Eksaktong interval",
    },
    "availability_request.next_day": {
        "it": "Termina il giorno successivo", "en": "Ends the following day",
        "fr": "Se termine le jour suivant", "es": "Termina al día siguiente",
        "de": "Endet am folgenden Tag", "ro": "Se încheie în ziua următoare",
        "uk": "Завершується наступного дня", "fil": "Matatapos sa susunod na araw",
    },
    "availability_request.next_day_help": {
        "it": "Solo per un intervallo notturno che supera la mezzanotte.",
        "en": "Only for an overnight interval that crosses midnight.",
        "fr": "Uniquement pour un horaire de nuit qui dépasse minuit.",
        "es": "Solo para un intervalo nocturno que pasa de medianoche.",
        "de": "Nur für einen nächtlichen Zeitraum über Mitternacht.",
        "ro": "Doar pentru un interval de noapte care trece de miezul nopții.",
        "uk": "Лише для нічного інтервалу, що переходить через північ.",
        "fil": "Para lamang sa overnight interval na lampas hatinggabi.",
    },
    "availability_request.remove_interval": {
        "it": "Rimuovi intervallo", "en": "Remove interval",
        "fr": "Supprimer l’horaire", "es": "Eliminar intervalo",
        "de": "Zeitraum entfernen", "ro": "Elimină intervalul",
        "uk": "Видалити інтервал", "fil": "Alisin ang interval",
    },
    "availability_request.submit": {
        "it": "Invia richiesta", "en": "Send request",
        "fr": "Envoyer la demande", "es": "Enviar solicitud",
        "de": "Anfrage senden", "ro": "Trimite solicitarea",
        "uk": "Надіслати запит", "fil": "Ipadala ang request",
    },
    "availability_request.submitting": {
        "it": "Invio in corso...", "en": "Sending...", "fr": "Envoi...",
        "es": "Enviando...", "de": "Wird gesendet...", "ro": "Se trimite...",
        "uk": "Надсилання...", "fil": "Ipinapadala...",
    },
    "availability_request.success_title": {
        "it": "Richiesta inviata", "en": "Request sent",
        "fr": "Demande envoyée", "es": "Solicitud enviada",
        "de": "Anfrage gesendet", "ro": "Solicitare trimisă",
        "uk": "Запит надіслано", "fil": "Naipadala ang request",
    },
    "availability_request.success_message": {
        "it": "Riceverai una notifica quando l’utente risponderà.",
        "en": "You will receive a notification when the user replies.",
        "fr": "Vous recevrez une notification lorsque l’utilisateur répondra.",
        "es": "Recibirás una notificación cuando el usuario responda.",
        "de": "Du erhältst eine Benachrichtigung, sobald der Nutzer antwortet.",
        "ro": "Vei primi o notificare când utilizatorul răspunde.",
        "uk": "Ви отримаєте сповіщення, коли користувач відповість.",
        "fil": "Makakatanggap ka ng notification kapag sumagot ang user.",
    },
    "availability_request.error_select_day": {
        "it": "Seleziona A chiamata oppure almeno un giorno.",
        "en": "Select On call or at least one day.",
        "fr": "Sélectionnez Sur appel ou au moins un jour.",
        "es": "Selecciona Bajo demanda o al menos un día.",
        "de": "Wähle Auf Abruf oder mindestens einen Tag.",
        "ro": "Selectează La cerere sau cel puțin o zi.",
        "uk": "Оберіть За викликом або щонайменше один день.",
        "fil": "Piliin ang On call o kahit isang araw.",
    },
    "availability_request.error_empty_day": {
        "it": "Per ogni giorno selezionato scegli almeno una fascia o aggiungi un intervallo preciso.",
        "en": "For each selected day, choose at least one time slot or add an exact interval.",
        "fr": "Pour chaque jour sélectionné, choisissez au moins un créneau ou ajoutez un horaire précis.",
        "es": "Para cada día seleccionado, elige al menos una franja o añade un intervalo exacto.",
        "de": "Wähle für jeden ausgewählten Tag mindestens ein Zeitfenster oder füge einen genauen Zeitraum hinzu.",
        "ro": "Pentru fiecare zi selectată, alege cel puțin un interval general sau adaugă unul exact.",
        "uk": "Для кожного вибраного дня виберіть щонайменше один часовий проміжок або додайте точний інтервал.",
        "fil": "Sa bawat napiling araw, pumili ng kahit isang time slot o magdagdag ng eksaktong interval.",
    },
    "availability_request.error_incomplete_interval": {
        "it": "Completa entrambi gli orari di ogni intervallo.",
        "en": "Complete both times for every interval.",
        "fr": "Renseignez les deux horaires de chaque intervalle.",
        "es": "Completa las dos horas de cada intervalo.",
        "de": "Gib für jeden Zeitraum Start- und Endzeit an.",
        "ro": "Completează ambele ore pentru fiecare interval.",
        "uk": "Вкажіть обидва значення часу для кожного інтервалу.",
        "fil": "Kumpletuhin ang simula at pagtatapos ng bawat interval.",
    },
    "availability_request.error_invalid_interval": {
        "it": "L’orario finale deve essere successivo a quello iniziale.",
        "en": "The end time must be later than the start time.",
        "fr": "L’heure de fin doit être postérieure à l’heure de début.",
        "es": "La hora final debe ser posterior a la inicial.",
        "de": "Die Endzeit muss nach der Startzeit liegen.",
        "ro": "Ora de încheiere trebuie să fie ulterioară celei de început.",
        "uk": "Час завершення має бути пізнішим за час початку.",
        "fil": "Dapat mas huli ang oras ng pagtatapos kaysa oras ng simula.",
    },
    "availability_request.error_invalid_night_interval": {
        "it": "Il giorno successivo è valido solo per un intervallo notturno che supera la mezzanotte.",
        "en": "The following-day option is only valid for an overnight interval that crosses midnight.",
        "fr": "L’option du jour suivant est valable uniquement pour un horaire de nuit qui dépasse minuit.",
        "es": "La opción del día siguiente solo es válida para un intervalo nocturno que pasa de medianoche.",
        "de": "Die Option „folgender Tag“ gilt nur für einen nächtlichen Zeitraum über Mitternacht.",
        "ro": "Opțiunea pentru ziua următoare este valabilă doar pentru un interval de noapte care trece de miezul nopții.",
        "uk": "Опція наступного дня дійсна лише для нічного інтервалу, що переходить через північ.",
        "fil": "Ang susunod na araw ay para lamang sa overnight interval na lampas hatinggabi.",
    },
    "availability_request.error_limit_per_day": {
        "it": "Puoi aggiungere al massimo 8 intervalli per ogni giorno.",
        "en": "You can add up to 8 intervals per day.",
        "fr": "Vous pouvez ajouter jusqu’à 8 horaires par jour.",
        "es": "Puedes añadir hasta 8 intervalos por día.",
        "de": "Du kannst höchstens 8 Zeiträume pro Tag hinzufügen.",
        "ro": "Poți adăuga cel mult 8 intervale pentru fiecare zi.",
        "uk": "Можна додати щонайбільше 8 інтервалів на день.",
        "fil": "Maaari kang magdagdag ng hanggang 8 interval bawat araw.",
    },
    "availability_request.error_limit_total": {
        "it": "Puoi aggiungere al massimo 28 intervalli in totale.",
        "en": "You can add up to 28 intervals in total.",
        "fr": "Vous pouvez ajouter jusqu’à 28 horaires au total.",
        "es": "Puedes añadir hasta 28 intervalos en total.",
        "de": "Du kannst insgesamt höchstens 28 Zeiträume hinzufügen.",
        "ro": "Poți adăuga cel mult 28 de intervale în total.",
        "uk": "Загалом можна додати щонайбільше 28 інтервалів.",
        "fil": "Maaari kang magdagdag ng hanggang 28 interval sa kabuuan.",
    },
    "availability_request.error_generic": {
        "it": "Impossibile inviare la richiesta. Riprova tra poco.",
        "en": "Unable to send the request. Please try again shortly.",
        "fr": "Impossible d’envoyer la demande. Réessayez dans quelques instants.",
        "es": "No se ha podido enviar la solicitud. Inténtalo de nuevo en breve.",
        "de": "Die Anfrage konnte nicht gesendet werden. Versuche es gleich noch einmal.",
        "ro": "Solicitarea nu a putut fi trimisă. Încearcă din nou în scurt timp.",
    ...
    "availability_request.profile_photo_required": {
        "it": "Per chiedere la disponibilità devi prima caricare una foto profilo. Verrai portato alla tua dashboard personale.",
        "en": "To ask about availability, you must first upload a profile photo. You will be taken to your personal dashboard.",
        "fr": "Pour demander une disponibilité, vous devez d’abord ajouter une photo de profil. Vous allez être redirigé vers votre tableau de bord personnel.",
        "es": "Para preguntar por la disponibilidad, primero debes subir una foto de perfil. Te llevaremos a tu panel personal.",
        "de": "Um nach der Verfügbarkeit zu fragen, musst du zuerst ein Profilfoto hochladen. Du wirst zu deinem persönlichen Bereich weitergeleitet.",
        "ro": "Pentru a solicita disponibilitatea, trebuie mai întâi să încarci o fotografie de profil. Vei fi redirecționat către panoul tău personal.",
        "uk": "Щоб запитати про доступність, спочатку завантажте фото профілю. Вас буде перенаправлено до особистої панелі.",
        "fil": "Bago humingi ng availability, kailangan mo munang mag-upload ng profile photo. Dadalhin ka sa iyong personal dashboard.",
    },
    "availability_request_owner.eyebrow": {
        "it": "PER IL TUO ANNUNCIO", "en": "FOR YOUR LISTING",
        "fr": "POUR VOTRE ANNONCE", "es": "PARA TU ANUNCIO",
        "de": "FÜR DEINE ANZEIGE", "ro": "PENTRU ANUNȚUL TĂU",
        "uk": "ДЛЯ ВАШОГО ОГОЛОШЕННЯ", "fil": "PARA SA LISTING MO",
    },
    "availability_request_owner.title": {
        "it": "Richieste di disponibilità", "en": "Availability requests",
        "fr": "Demandes de disponibilité", "es": "Solicitudes de disponibilidad",
        "de": "Verfügbarkeitsanfragen", "ro": "Solicitări de disponibilitate",
        "uk": "Запити щодо доступності", "fil": "Mga availability request",
    },
    "availability_request_owner.subtitle": {
        "it": "Controlla i giorni e gli orari richiesti e rispondi con un tocco.",
        "en": "Review the requested days and times and reply with one tap.",
        "fr": "Consultez les jours et horaires demandés et répondez en un geste.",
        "es": "Revisa los días y horarios solicitados y responde con un toque.",
        "de": "Prüfe die gewünschten Tage und Zeiten und antworte mit einem Fingertipp.",
        "ro": "Verifică zilele și orele solicitate și răspunde printr-o atingere.",
        "uk": "Перегляньте запитані дні й час і дайте відповідь одним дотиком.",
        "fil": "Tingnan ang hinihinging mga araw at oras at sumagot sa isang tap.",
    },
    "availability_request_owner.count": {
        "it": "Richieste: {count}", "en": "Requests: {count}",
        "fr": "Demandes : {count}", "es": "Solicitudes: {count}",
        "de": "Anfragen: {count}", "ro": "Solicitări: {count}",
        "uk": "Запити: {count}", "fil": "Mga request: {count}",
    },
    "availability_request_owner.empty_title": {
        "it": "Nessuna richiesta", "en": "No requests",
        "fr": "Aucune demande", "es": "No hay solicitudes",
        "de": "Keine Anfragen", "ro": "Nicio solicitare",
        "uk": "Немає запитів", "fil": "Walang request",
    },
    "availability_request_owner.empty_body": {
        "it": "Quando qualcuno chiederà la tua disponibilità, troverai qui giorni e orari.",
        "en": "When someone asks about your availability, their requested days and times will appear here.",
        "fr": "Lorsqu’une personne demandera vos disponibilités, les jours et horaires souhaités apparaîtront ici.",
        "es": "Cuando alguien consulte tu disponibilidad, aquí aparecerán los días y horarios solicitados.",
        "de": "Wenn jemand deine Verfügbarkeit anfragt, erscheinen die gewünschten Tage und Zeiten hier.",
        "ro": "Când cineva îți solicită disponibilitatea, zilele și orele cerute vor apărea aici.",
        "uk": "Коли хтось запитає про вашу доступність, тут з’являться потрібні дні й час.",
        "fil": "Kapag may nagtanong tungkol sa availability mo, lalabas dito ang hinihinging mga araw at oras.",
    },
    "availability_request_owner.avatar_alt": {
        "it": "Foto profilo di {username}", "en": "Profile photo of {username}",
        "fr": "Photo de profil de {username}", "es": "Foto de perfil de {username}",
        "de": "Profilfoto von {username}", "ro": "Fotografia de profil a lui {username}",
        "uk": "Фото профілю {username}", "fil": "Profile photo ni {username}",
    },
    "availability_request_owner.avatar_placeholder": {
        "it": "Profilo di {username} senza foto", "en": "Profile of {username} without a photo",
        "fr": "Profil de {username} sans photo", "es": "Perfil de {username} sin foto",
        "de": "Profil von {username} ohne Foto", "ro": "Profilul lui {username} fără fotografie",
        "uk": "Профіль {username} без фото", "fil": "Profile ni {username} na walang larawan",
    },
    "availability_request_owner.zone_unknown": {
        "it": "Zona non indicata", "en": "Area not provided",
        "fr": "Zone non indiquée", "es": "Zona no indicada",
        "de": "Ort nicht angegeben", "ro": "Zona nu este indicată",
        "uk": "Район не вказано", "fil": "Hindi nakasaad ang lugar",
    },
    "availability_request_owner.sent_on": {
        "it": "Inviata il", "en": "Sent on", "fr": "Envoyée le",
        "es": "Enviada el", "de": "Gesendet am", "ro": "Trimisă la",
        "uk": "Надіслано", "fil": "Ipinadala noong",
    },
    "availability_request_owner.state_pending": {
        "it": "In attesa", "en": "Awaiting reply", "fr": "En attente",
        "es": "Pendiente", "de": "Wartet auf Antwort", "ro": "În așteptare",
        "uk": "Очікує відповіді", "fil": "Naghihintay ng sagot",
    },
    "availability_request_owner.state_available": {
        "it": "Disponibile", "en": "Available", "fr": "Disponible",
        "es": "Disponible", "de": "Verfügbar", "ro": "Disponibil",
        "uk": "Доступно", "fil": "Available",
    },
    "availability_request_owner.state_unavailable": {
        "it": "Non disponibile", "en": "Unavailable", "fr": "Indisponible",
        "es": "No disponible", "de": "Nicht verfügbar", "ro": "Indisponibil",
        "uk": "Недоступно", "fil": "Hindi available",
    },
    "availability_request_owner.state_information": {
        "it": "Servono informazioni", "en": "More information needed",
        "fr": "Informations nécessaires", "es": "Se necesita más información",
        "de": "Weitere Informationen nötig", "ro": "Sunt necesare informații",
        "uk": "Потрібна додаткова інформація", "fil": "Kailangan ng karagdagang impormasyon",
    },
    "availability_request_owner.state_expired": {
        "it": "Scaduta", "en": "Expired", "fr": "Expirée",
        "es": "Caducada", "de": "Abgelaufen", "ro": "Expirată",
        "uk": "Строк минув", "fil": "Nag-expire",
    },
    "availability_request_owner.schedule_title": {
        "it": "Giorni e orari richiesti", "en": "Requested days and times",
        "fr": "Jours et horaires demandés", "es": "Días y horarios solicitados",
        "de": "Gewünschte Tage und Zeiten", "ro": "Zilele și orele solicitate",
        "uk": "Запитані дні й час", "fil": "Hinihinging mga araw at oras",
    },
    "availability_request_owner.next_day_short": {
        "it": "+1 giorno", "en": "+1 day", "fr": "+1 jour",
        "es": "+1 día", "de": "+1 Tag", "ro": "+1 zi",
        "uk": "+1 день", "fil": "+1 araw",
    },
    "availability_request_owner.no_schedule": {
        "it": "Nessun orario indicato", "en": "No times provided",
        "fr": "Aucun horaire indiqué", "es": "No se han indicado horarios",
        "de": "Keine Zeiten angegeben", "ro": "Nu au fost indicate ore",
        "uk": "Час не вказано", "fil": "Walang nakasaad na oras",
    },
    "availability_request_owner.view_profile": {
        "it": "Vedi profilo", "en": "View profile", "fr": "Voir le profil",
        "es": "Ver perfil", "de": "Profil ansehen", "ro": "Vezi profilul",
        "uk": "Переглянути профіль", "fil": "Tingnan ang profile",
    },
    "availability_request_owner.answer_title": {
        "it": "La tua risposta", "en": "Your reply", "fr": "Votre réponse",
        "es": "Tu respuesta", "de": "Deine Antwort", "ro": "Răspunsul tău",
        "uk": "Ваша відповідь", "fil": "Sagot mo",
    },
    "availability_request_owner.answer_available": {
        "it": "Sono disponibile", "en": "I’m available", "fr": "Je suis disponible",
        "es": "Estoy disponible", "de": "Ich bin verfügbar", "ro": "Sunt disponibil",
        "uk": "Я доступний(-а)", "fil": "Available ako",
    },
    "availability_request_owner.answer_unavailable": {
        "it": "Non sono disponibile", "en": "I’m not available",
        "fr": "Je ne suis pas disponible", "es": "No estoy disponible",
        "de": "Ich bin nicht verfügbar", "ro": "Nu sunt disponibil",
        "uk": "Я недоступний(-а)", "fil": "Hindi ako available",
    },
    "availability_request_owner.answer_information": {
        "it": "Ho bisogno di informazioni", "en": "I need more information",
        "fr": "J’ai besoin d’informations", "es": "Necesito más información",
        "de": "Ich brauche weitere Informationen", "ro": "Am nevoie de informații",
        "uk": "Мені потрібна додаткова інформація", "fil": "Kailangan ko ng karagdagang impormasyon",
    },
    "availability_request_owner.sending": {
        "it": "Invio...", "en": "Sending...", "fr": "Envoi...",
        "es": "Enviando...", "de": "Wird gesendet...", "ro": "Se trimite...",
        "uk": "Надсилання...", "fil": "Ipinapadala...",
    },
    "availability_request_owner.answer_recorded": {
        "it": "Risposta registrata", "en": "Reply recorded",
        "fr": "Réponse enregistrée", "es": "Respuesta registrada",
        "de": "Antwort gespeichert", "ro": "Răspuns înregistrat",
        "uk": "Відповідь збережено", "fil": "Naitala ang sagot",
    },
    "availability_request_owner.error_generic": {
        "it": "Impossibile registrare la risposta. Riprova tra poco.",
        "en": "Unable to record your reply. Please try again shortly.",
        "fr": "Impossible d’enregistrer votre réponse. Réessayez dans quelques instants.",
        "es": "No se ha podido registrar tu respuesta. Inténtalo de nuevo en breve.",
        "de": "Deine Antwort konnte nicht gespeichert werden. Versuche es gleich noch einmal.",
        "ro": "Răspunsul nu a putut fi înregistrat. Încearcă din nou în scurt timp.",
        "uk": "Не вдалося зберегти відповідь. Спробуйте ще раз трохи пізніше.",
        "fil": "Hindi maitala ang sagot. Subukan muli maya-maya.",
    },
    "availability_request_owner.error_conflict": {
        "it": "La richiesta è già stata aggiornata. Ricarica la pagina per vedere lo stato più recente.",
        "en": "This request has already been updated. Reload the page to see its latest status.",
        "fr": "Cette demande a déjà été mise à jour. Rechargez la page pour voir son état actuel.",
        "es": "Esta solicitud ya se ha actualizado. Recarga la página para ver el estado más reciente.",
        "de": "Diese Anfrage wurde bereits aktualisiert. Lade die Seite neu, um den aktuellen Status zu sehen.",
        "ro": "Această solicitare a fost deja actualizată. Reîncarcă pagina pentru a vedea starea actuală.",
        "uk": "Цей запит уже оновлено. Перезавантажте сторінку, щоб побачити актуальний стан.",
        "fil": "Na-update na ang request na ito. I-reload ang page para makita ang pinakabagong status.",
    },
    "availability_request_chat.listing_fallback": {
        "it": "Annuncio", "en": "Listing", "fr": "Annonce",
        "es": "Anuncio", "de": "Anzeige", "ro": "Anunț",
        "uk": "Оголошення", "fil": "Listing",
    },
    "availability_request_chat.sent_by_you": {
        "it": "Richiesta inviata da te", "en": "Request sent by you",
        "fr": "Demande envoyée par vous", "es": "Solicitud enviada por ti",
        "de": "Von dir gesendete Anfrage", "ro": "Solicitare trimisă de tine",
        "uk": "Запит надіслано вами", "fil": "Request na ipinadala mo",
    },
    "availability_request_chat.received_by_you": {
        "it": "Richiesta ricevuta", "en": "Request received",
        "fr": "Demande reçue", "es": "Solicitud recibida",
        "de": "Anfrage erhalten", "ro": "Solicitare primită",
        "uk": "Отриманий запит", "fil": "Natanggap na request",
    },
    "availability_request_chat.view_listing": {
        "it": "Vedi annuncio", "en": "View listing", "fr": "Voir l’annonce",
        "es": "Ver anuncio", "de": "Anzeige ansehen", "ro": "Vezi anunțul",
        "uk": "Переглянути оголошення", "fil": "Tingnan ang listing",
    },
    "availability_request_chat.blocked": {
        "it": "Non puoi rispondere mentre la conversazione è bloccata.",
        "en": "You cannot reply while the conversation is blocked.",
        "fr": "Vous ne pouvez pas répondre tant que la conversation est bloquée.",
        "es": "No puedes responder mientras la conversación esté bloqueada.",
        "de": "Du kannst nicht antworten, solange der Chat blockiert ist.",
        "ro": "Nu poți răspunde cât timp conversația este blocată.",
        "uk": "Ви не можете відповісти, доки розмову заблоковано.",
        "fil": "Hindi ka makakasagot habang naka-block ang usapan.",
    },
    "availability_request_chat.awaiting_reply": {
        "it": "In attesa della risposta dell’utente.",
        "en": "Waiting for the user’s reply.",
        "fr": "En attente de la réponse de l’utilisateur.",
        "es": "A la espera de la respuesta del usuario.",
        "de": "Warten auf die Antwort des Nutzers.",
        "ro": "Se așteaptă răspunsul utilizatorului.",
        "uk": "Очікується відповідь користувача.",
        "fil": "Naghihintay sa sagot ng user.",
    },
    ...
    "availability_request_chat.response_received": {
        "it": "Risposta ricevuta", "en": "Reply received",
        "fr": "Réponse reçue", "es": "Respuesta recibida",
        "de": "Antwort erhalten", "ro": "Răspuns primit",
        "uk": "Відповідь отримано", "fil": "Natanggap na sagot",
    },
    "availability_request_chat.response_available": {
        "it": "La persona ha confermato la disponibilità richiesta.",
        "en": "The person confirmed the requested availability.",
        "fr": "La personne a confirmé la disponibilité demandée.",
        "es": "La persona confirmó la disponibilidad solicitada.",
        "de": "Die Person hat die angefragte Verfügbarkeit bestätigt.",
        "ro": "Persoana a confirmat disponibilitatea solicitată.",
        "uk": "Користувач підтвердив запитану доступність.",
        "fil": "Kinumpirma ng tao ang hinihinging availability.",
    },
    "availability_request_chat.response_unavailable": {
        "it": "La persona ha indicato di non essere disponibile.",
        "en": "The person said they are not available.",
        "fr": "La personne a indiqué qu’elle n’était pas disponible.",
        "es": "La persona indicó que no está disponible.",
        "de": "Die Person hat angegeben, nicht verfügbar zu sein.",
        "ro": "Persoana a indicat că nu este disponibilă.",
        "uk": "Користувач повідомив, що недоступний.",
        "fil": "Sinabi ng tao na hindi siya available.",
    },
    "availability_request_chat.response_information": {
        "it": "La persona ha bisogno di maggiori informazioni prima di confermare.",
        "en": "The person needs more information before confirming.",
        "fr": "La personne a besoin de plus d’informations avant de confirmer.",
        "es": "La persona necesita más información antes de confirmar.",
        "de": "Die Person benötigt vor der Bestätigung weitere Informationen.",
        "ro": "Persoana are nevoie de mai multe informații înainte de confirmare.",
        "uk": "Користувачеві потрібна додаткова інформація перед підтвердженням.",
        "fil": "Kailangan ng tao ng dagdag na impormasyon bago magkumpirma.",
    },
    "availability_request_chat.response_for_listing": {
        "it": "Per la tua richiesta su {listing}",
        "en": "For your request about {listing}",
        "fr": "Pour votre demande concernant {listing}",
        "es": "Para tu solicitud sobre {listing}",
        "de": "Zu deiner Anfrage für {listing}",
        "ro": "Pentru solicitarea ta privind {listing}",
        "uk": "Щодо вашого запиту про {listing}",
        "fil": "Para sa request mo tungkol sa {listing}",
    },
