...
TRANSLATIONS = {
    ...
    "availability_request.open": {
        "it": "Chiedi disponibilità", "en": "Ask about availability",
        "fr": "Demander les disponibilités", "es": "Consultar disponibilidad",
        "de": "Verfügbarkeit anfragen", "ro": "Întreabă despre disponibilitate",
        "uk": "Запитати про доступність", "fil": "Magtanong tungkol sa availability",
    },
