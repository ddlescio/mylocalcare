...
TRANSLATIONS = {
    ...
    "profile_card.saved": {
        "it": "Scheda salvata.", "en": "Card saved.", "fr": "Fiche enregistrée.",
        "es": "Ficha guardada.", "de": "Profilkarte gespeichert.", "ro": "Fișă salvată.",
        "uk": "Картку збережено.", "fil": "Na-save ang card.",
    },
    "profile_card.saved_requested": {
        "it": "Scheda salvata e controllo richiesto.",
        "en": "Card saved and check requested.",
        "fr": "Fiche enregistrée et contrôle demandé.",
        "es": "Ficha guardada y comprobación solicitada.",
        "de": "Profilkarte gespeichert und Prüfung angefordert.",
        "ro": "Fișă salvată și verificare solicitată.",
        "uk": "Картку збережено та перевірку запитано.",
        "fil": "Na-save ang card at hiniling ang pagsusuri.",
    },
